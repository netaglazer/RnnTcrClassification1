...
from loss import new_loss_function
...
def run(args):
    epoch_count = 10
    model = LSTMClassifier(args.batch_size, args.output_size, args.hidden_size, args.vocab_size, args.embedding_length, args.word_embeddings)
